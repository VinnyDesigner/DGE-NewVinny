...
function Login() {
  ...
  return (
    <div className="relative h-dvh max-h-dvh w-full overflow-hidden bg-background text-foreground flex flex-col justify-between select-none">
      ...
      <ResetOverlay isOpen={isResetOpen} onClose={() => setIsResetOpen(false)} onSubmit={handleResetSubmit} />
    </div>
  );
}
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          <div className="max-w-3xl mx-auto px-6 py-16 space-y-12 pb-32">
            <div className="text-center space-y-4">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 px-3.5 py-1 text-[11px] font-bold uppercase tracking-wider text-blue-400">
                {isPrivacy ? "// COMPLIANCE POLICY" : "// LEGAL AGREEMENT"}
              </span>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">{title}</h1>
              <p className="text-xs text-muted-foreground">{subtitle}</p>
            </div>

            <div className="space-y-8 border-t border-white/[0.06] pt-12 text-sm text-slate-300 font-medium leading-relaxed">
              {isPrivacy ? (
                <>
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">1. Introduction & Overview</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">2. Information We Collect</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">3. Purpose of Processing</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">4. Data Protection & Encryption</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">5. User Audits & Retention</h3>
                    <p>
                ...
                <>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">2. Authorized Access Only</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">3. User Responsibilities</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">4. System Logging & Service Level SLA</h3>
                    <p>
                  ...
                  <section className="space-y-3 text-left">
                    <h3 className="text-white font-bold text-base">5. Termination & Suspension</h3>
                    <p>
            ...
            <div className="pt-8 border-t border-white/[0.06] flex justify-center">
              <button
                onClick={onClose}
                className="h-10 px-6 rounded-full bg-blue-600 hover:bg-blue-500 font-bold text-xs text-white transition-all hover:-translate-y-0.5 cursor-pointer shadow-soft"
              >
                Acknowledge & Close
              </button>
            </div>
...
/* ------------------------------------------------------------------ */
/* Forgot Password Reset Overlay Component                           */
/* ------------------------------------------------------------------ */
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 30 }}
          transition={{ duration: 0.35, ease: "easeOut" }}
          className="fixed inset-0 z-50 overflow-hidden bg-[#030611] text-foreground flex flex-col justify-between select-none"
        >
          <AmbientBackdrop />

          {/* Header Bar */}
          <div className="relative z-10 w-full bg-[#030611]/85 backdrop-blur-md border-b border-white/[0.06] h-[64px] px-6 flex items-center justify-between shrink-0">
            <button
              onClick={onClose}
              className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground/85 hover:text-foreground cursor-pointer transition-colors"
            >
          ...
          <div className="relative z-10 flex-1 flex items-center justify-center p-6">
            <div className="w-full max-w-[440px]">
              ...
              >
                {/* Card Container */}
                <div
                  className="relative overflow-hidden rounded-3xl p-8 border border-white/[0.08]"
                  style={{
                    backgroundColor: "rgba(14, 24, 40, 0.55)",
                    backdropFilter: "blur(24px)",
                    WebkitBackdropFilter: "blur(24px)",
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center gap-3.5">
                      <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-soft shrink-0">
                    ...
                    <div className="mt-6 space-y-4">
                      <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-semibold tracking-wider text-muted-foreground/80 uppercase">
                          USERNAME
                        </label>
                        <div
                          className="group relative flex h-11 items-center gap-2.5 overflow-hidden rounded-full border px-4 border-white/[0.10] bg-white/[0.04] hover:border-white/[0.18] transition-all duration-300"
                          style={{
                            boxShadow:
                              "inset 0 1px 0 rgba(255, 255, 255, 0.10), inset 0 -1px 0 rgba(255, 255, 255, 0.02), 0 8px 24px -12px rgba(0, 0, 0, 0.6)",
                            backgroundImage:
                        ...
                        >
                          ...
                          <div className="relative flex-1">
                            <input
                              ...
                              className="peer relative h-full w-full bg-transparent py-0 text-sm text-foreground outline-none placeholder:text-muted-foreground/40"
                            />
                          </div>
                        </div>
                      </div>
                      ...
                      <motion.button
                        ...
                        className="group relative mt-2 inline-flex h-11 w-full items-center justify-center gap-2 overflow-hidden rounded-full bg-primary text-xs font-semibold tracking-tight text-primary-foreground shadow-[0_12px_40px_-12px_rgba(59,130,246,0.55)] transition-all login-cta-button"
                      >
                        <span className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-b from-white/20 via-transparent to-transparent" />
                        <span className="pointer-events-none absolute inset-0 rounded-full ring-1 ring-inset ring-white/20" />
                        <span className="pointer-events-none absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-white/35 to-transparent" />
          ...
          {/* Footer info placeholder to push layout */}
